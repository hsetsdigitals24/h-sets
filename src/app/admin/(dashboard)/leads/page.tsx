...
export default async function LeadsPage({
  ...
  if (sp.type) exportQuery.set("type", sp.type);
  ...
  return (
    <div>
      ...
      <form className="mb-4 flex flex-wrap items-end gap-3" method="get">
        ...
        <Select name="type" defaultValue={sp.type ?? ""} className="w-auto min-w-[150px]">
        ...
        <Select name="status" defaultValue={sp.status ?? ""} className="w-auto min-w-[150px]">
