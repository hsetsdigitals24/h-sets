...
export default async function PortfolioItemPage({
  ...
  const related = (await Promise.all(study.related.map((s) => getPortfolioItem(s)))).filter(
  ...
  const crumbs = [
    ...
    { name: study.client, href: `/portfolio/${study.slug}` },
  ];
